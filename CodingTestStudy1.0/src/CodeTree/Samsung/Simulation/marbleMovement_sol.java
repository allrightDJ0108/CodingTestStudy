...
public class marbleMovement_sol {
    
    public static int n, m, t, k;
    public static ArrayList<Tuple>[][] grid = new ArrayList[50][50];
    public static ArrayList<Tuple>[][] nextGrid = new ArrayList[50][50];
        ...
        for(int x = 0; x < n; x++)
            for(int y = 0; y < n; y++) {
                ...
                for(int i = 0; i < (int) grid[x][y].size(); i++) {
                    ...
                    System.out.println((nextX+1) + " " + (nextY+1) + " " + v + " "+num+" "+nextDir);
                }
            }
    }
